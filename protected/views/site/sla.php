...
<h2>Vista General</h2>
<script
	src="<?php echo Yii::app()->baseUrl;?>/js/highcharts/highcharts.js"></script>
<script
	src="<?php echo Yii::app()->baseUrl;?>/js/highcharts/highcharts-more.js"></script>
<script
	src="<?php echo Yii::app()->baseUrl;?>/js/highcharts/modules/solid-gauge.src.js"></script>

<div id="Cumplimiento-SLA-Historico-Simple"
	style="min-width: 310px; height: 400px; margin: 0 auto"></div>
<div id="Cumplimiento-SLA-Cliente"
	style="width: 700px; height: 500px; margin: 0 auto 0 auto;"></div>
<div id="Cumplimiento-SLA-Historico"
	style="min-width: 310px; height: 400px; margin: 0 auto"></div>
...
<div id="Cumplimiento-SLA-Historico-Servicios"
	style="min-width: 310px; height: 400px; margin: 0 auto"></div>

<div id="Cumplimiento-SLA-Contrato"
	style="min-width: 310px; height: 400px; margin: 0 auto"></div>
