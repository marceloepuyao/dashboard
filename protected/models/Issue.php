...
class Issue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('linea_servicio_id, cliente_id', 'required'),
			array('linea_servicio_id, cliente_id, solucionado, criticidad', 'numerical', 'integerOnly'=>true),
			array('descripcion, fecha', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, linea_servicio_id, cliente_id, descripcion, fecha, solucionado, criticidad', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'linea_servicio_id' => 'Línea Servicio',
			'cliente_id' => 'Cliente',
